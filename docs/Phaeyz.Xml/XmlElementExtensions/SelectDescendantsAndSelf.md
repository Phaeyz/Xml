# XmlElementExtensions.SelectDescendantsAndSelf method

Selects descendant elements and the current XmlElement.

```csharp
public static IEnumerable<XmlElement> SelectDescendantsAndSelf(this XmlElement @this, 
    string? namespaceUri = null, string? localName = null)
```

| parameter | description |
| --- | --- |
| this | The XmlElement to select along with descendant elements. |
